...
A public key certificate is an electronic document used to prove the validity of a public key. It includes the public key and information about it, about the identity of its owner, and the **digital signature** of an entity that has verified the certificate's contents.
