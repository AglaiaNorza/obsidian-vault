> [!info]- index
> - [dispositivi di I/O](#dispositivi%20di%20I/O)
> 	- [funzionamento](#funzionamento)
> 	- [differenze tra dispositivi I/O](#differenze%20tra%20dispositivi%20I/O)
> - [organizzazione della funzione di I/O](#organizzazione%20della%20funzione%20di%20I/O)
> 	- [approfondimento: DMA](#approfondimento:%20DMA)
> 	- [evoluzione della funzione di I/O](#evoluzione%20della%20funzione%20di%20I/O)
> - [problemi nel progetto del sistema operativo](#problemi%20nel%20progetto%20del%20sistema%20operativo)
> 	- [efficienza](#efficienza)
> 	- [generalità](#generalit%C3%A0)
> 	- [progettazione gerarchica](#progettazione%20gerarchica)
> 		- [1 - dispositivo locale](#1%20-%20dispositivo%20locale)
> 		- [2 - dispositivo di comunicazione](#2%20-%20dispositivo%20di%20comunicazione)
> 		- [3 - file system](#3%20-%20file%20system)
> - [buffering dell'I/O](#buffering%20dell'I/O)
> 	- [senza buffer](#senza%20buffer)
> 	- [buffer singolo](#buffer%20singolo)
> 	- [buffer singolo orientato ai blocchi](#buffer%20singolo%20orientato%20ai%20blocchi)
> 	- [buffer singolo orientato agli stream](#buffer%20singolo%20orientato%20agli%20stream)
> 	- [buffer doppio](#buffer%20doppio)
> 	- [buffer circolare](#buffer%20circolare)
> 	- [buffer: pro e contro](#buffer:%20pro%20e%20contro)
> 		- [overhead e buffer zero copy](#overhead%20e%20buffer%20zero%20copy)
> - [scheduling del disco](#scheduling%20del%20disco)
> 	- [HDD vs SSD](#HDD%20vs%20SSD)
> 	- [il disco](#il%20disco)
...
> 	- [summa](#summa)
> - [SSD: cenni](#SSD:%20cenni)
> 	- [operazioni](#operazioni)
> - [cache del disco](#cache%20del%20disco)
> 	- [LRU](#LRU)
> 	- [LFU](#LFU)
> 	- [sostituzione basata su frequenza](#sostituzione%20basata%20su%20frequenza)
> 	- [sostituzione basata su frequenza: 3 segmenti](#sostituzione%20basata%20su%20frequenza:%203%20segmenti)
> - [RAID](#RAID)
> 	- [dischi multipli e RAID](#dischi%20multipli%20e%20RAID)
> 	- [gerarchia dei dischi RAID](#gerarchia%20dei%20dischi%20RAID)
> 		- [RAID 0 (nonredundant)](#RAID%200%20(nonredundant))
> 		- [RAID 1 (mirrored)](#RAID%201%20(mirrored))
> 		- [RAID 2 (redundancy through Hamming code)](#RAID%202%20(redundancy%20through%20Hamming%20code))
> 		- [RAID 3 (bit-interleaved parity)](#RAID%203%20(bit-interleaved%20parity))
> 		- [RAID 4 (block-level parity)](#RAID%204%20(block-level%20parity))
> 		- [RAID 5 (block-level distributed parity)](#RAID%205%20(block-level%20distributed%20parity))
> 		- [RAID 6 (dual redundancy)](#RAID%206%20(dual%20redundancy))
> 	- [riassunto](#riassunto)
> - [I/O in Linux](#I/O%20in%20Linux)
